...
//				    ShellViewModel.LoadPMD (root, "/mikuXSc", "/mikuXS.pmd");
			...
			configButton = FindViewById<ImageButton> (Resource.Id.ConfigButton);
...
//				FragmentManager.BeginTransaction().Replace(Resource.Id.ShellFrame, new SettingFragment()).Commit();
			};
